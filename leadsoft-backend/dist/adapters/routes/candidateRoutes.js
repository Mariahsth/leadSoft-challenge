...
const DeleteCandidate_1 = require("../../application/use-cases/DeleteCandidate");
...
const deleteCandidate = new DeleteCandidate_1.DeleteCandidate(candidateRepository);
const candidateController = new CandidateController_1.CandidateController(registerCandidate, deleteCandidate, candidateRepository);
router.post('/register', upload_1.default.single('image'), candidateController.register.bind(candidateController));
...
router.delete('/candidates/:id', authMiddleware_1.authMiddleware, candidateController.delete.bind(candidateController));
